...
// initialisation du module RTC      
  ...
  if (rtc.lostPower()) {
   ...
   //rtc.adjust(DateTime(2023, 4, 02, 20, 05, 30)); 
...
void mp3_debug() {
    player.play(0002);  
    Serial.println(" mp3 2 07h00");
    delay(10000);
    player.play(0003);  
     Serial.println(" mp3 3 07h30");
    delay(10000);
    player.play(0004); 
     Serial.println(" mp3 4 08h00");
    delay(10000);
    player.play(0005);  
     Serial.println(" mp3 5 08h30");
    delay(10000);
    player.play(0006); 
     Serial.println(" mp3 6 09h00");
    delay(10000);
     player.play(0007);  
     Serial.println("mp3 7 09h30");
    delay(10000);
    player.play(0026);  
     Serial.println("mp3 26 10h00");
    delay(10000);
     player.play(0130);  
     Serial.println("mp3 130 10h30");
    delay(10000);
    player.play(0010);  
     Serial.println("mp3 10 11h00");
   delay(10000);   
    player.play(0011);  
     Serial.println("mp3 11 11h30");
    delay(10000);   
    player.play(0012); 
     Serial.println("mp3 12 12h00");
    delay(10000);
    player.play(0013);  
     Serial.println("mp3 13 12h30");
    delay(10000);
    player.play(0014);  
     Serial.println("mp3 14 13h00");
   delay(10000);
    player.play(0015);  
     Serial.println("mp3 15 13h30");
   delay(10000);
    player.play(0016);  
     Serial.println("mp3 16 14h00");
   delay(10000);
    player.play(0017);  
     Serial.println("mp3 17 14h30");
   delay(10000);
     player.play(0020);  
     Serial.println("mp3 20 15h00");
   delay(10000);
    player.play(0021);  
     Serial.println("mp3 21 15h30");
   delay(10000);
    player.play(0022);  
     Serial.println("mp3 22 16h00");
  delay(10000);
    player.play(0023);  
    Serial.println("mp3 23 16h30");
   delay(10000);
    player.play(0024);  
    Serial.println("mp3 24 17h00");
    delay(10000);  
     player.play(0025);  
    Serial.println("mp3 25 17h30");
    delay(10000);  
}    
